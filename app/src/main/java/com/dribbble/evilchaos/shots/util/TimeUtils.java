...
public class TimeUtils {
    ...
    public final static String FORMAT_STANDARD_TIME = "yyyy-MM-dd'T'HH:mm:ss'Z'";
    ...
    public static String getTimeFromStandardFormat(String time) {
        try {
            SimpleDateFormat format = new SimpleDateFormat(FORMAT_STANDARD_TIME, Locale.US);
